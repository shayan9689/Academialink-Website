/**
 * SVG icons and logo for Academialink – symbols only, no placeholder boxes.
 */
...
export function LogoIcon({ className }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M18 2L4 8v10c0 7.5 6 13.5 14 16 8-2.5 14-8.5 14-16V8L18 2z"
        fill="#93C5FD"
      />
      <text
        x="18"
...
/** Logo for dark theme (lighter shield + light text for dark backgrounds) */
...
export function PapersIcon({ className }: { className?: string }) {
  return (
    <svg className={className} width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
      <path d="M14 2v6h6" />
...
export function FeatureBadgeIcon({ className }: { className?: string }) {
  return (
    <svg className={className} width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
