...
export default function SubmitPeerReviewModal({ open, onClose, paperTitle }: SubmitPeerReviewModalProps) {
      ...
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.footer}>
          ...
          <div className={styles.actions}>
            <button type="button" className={styles.cancelBtn} onClick={onClose} disabled={posted}>Cancel</button>
            <button type="button" className={styles.submitBtn} onClick={handleSubmit} disabled={posted}>
              {posted ? 'Posted' : 'Submit Review'}
            </button>
          </div>
        </div>
      </div>
