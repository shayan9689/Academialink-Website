            ...
            <aside className={layoutStyles.sidebar}>
              <div className={layoutStyles.sidebarInner}>
                ...
                <div className={layoutStyles.sidebarBottom}>
                  <Link href="/sign-out" className={`${layoutStyles.sidebarLink} ${layoutStyles.sidebarLinkSignOut}`}><SignOutIcon /><span className={layoutStyles.sidebarLinkText}>Sign Out</span></Link>
                </div>
              </div>
            </aside>
            <main className={layoutStyles.main}>
              <PageTransition>
                <div className={styles.content}>
                  ...
                  <p className={styles.subtitle}>Get the most out of AcademiaLink.</p>
                  <ul className={styles.list}>
                    <li>Upload your papers with a clear title and abstract so they’re easy to discover.</li>
                    <li>Use the Explore section to find related work and cite it in your submissions.</li>
                    <li>Submit peer reviews from the document page to contribute to the community.</li>
                    <li>Keep your profile up to date so collaborators can find you.</li>
                  </ul>
