...
export default function HomePage() {
  return (
    ...
    <div className={styles.page}>
      ...
      {/* ----- Feature 1: Seamless Peer Review ----- */}
      <AnimateInView
        as="section"
        className={styles.feature}
        aria-labelledby="feature-peer-review"
      >
      ...
      {/* ----- Feature 2: Global Distribution ----- */}
      <AnimateInView
        as="section"
        className={`${styles.feature} ${styles.featureReverse}`}
        aria-labelledby="feature-distribution"
      >
        <div className={styles.featureContent}>
          <FeatureBadgeIcon className={styles.featureIconSvg} />
      ...
      {/* ----- Feature 3: Advanced Version Control ----- */}
      <AnimateInView
        as="section"
        className={styles.feature}
        aria-labelledby="feature-version-control"
      >
        <div className={styles.featureContent}>
          <FeatureBadgeIcon className={styles.featureIconSvg} />
        ...
        <div className={styles.featureImageWrap}>
          <Image
            src="/images/version-control.png?v=2"
